    ...
    <div className="min-h-screen">
      ...
      >
        <div className="container mx-auto px-4 flex items-center justify-center gap-2 flex-wrap">
          ...
          <span>👩‍💼 Está <strong>Open to Work</strong>?</span>
          <span>Acesse o TalentPass por apenas <strong>R$ 9,80/mês</strong></span>
        </div>
      </div>
      <Navbar />
      <Hero />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl lg:text-4xl font-bold mb-4">
              Torne-se um <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Talent Partner</span>
            </h2>
            
            <p className="text-lg text-muted-foreground mb-3">
              Indique empresas para o TalentPass e receba <strong className="text-indigo-600">40% de comissão recorrente</strong> sobre tudo o que elas investirem enquanto forem clientes ativos.
            </p>
            ...
            <p className="text-sm text-muted-foreground mb-6">
              Ideal para consultores de RH, coaches, profissionais de vendas e qualquer pessoa que tenha relacionamento com empresas.
            </p>
            
            <Button 
              size="lg" 
              className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 shadow-lg"
              onClick={() => window.open('https://wa.me/5511955842951?text=Olá!%20Quero%20participar%20do%20programa%20Talent%20Partner%20e%20indicar%20empresas%20para%20o%20TalentPass.', '_blank')}
            >
              Quero participar 🚀
            </Button>
            
            <p className="text-xs text-muted-foreground mt-4">
              Sem custos iniciais. Gestão manual via WhatsApp durante o MVP.
            </p>
          </div>
        </div>
      </section>
